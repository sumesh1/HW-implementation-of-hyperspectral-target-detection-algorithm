...
resACER = hyperAceR_FP(double(M16),double(target16)');
resASMF = hyperASMF_FP(double(M16),double(target16)');
resASMF2 = hyperASMF2_FP(double(M16),double(target16)');
resCEM = hyperCem_FP(double(M16),double(target16)');
