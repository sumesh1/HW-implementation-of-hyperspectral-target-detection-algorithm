...
void cubedma(datatype* source, outputtype* destin, int COMPONENTS){
	...
	//err = ERR_TIMEOUT;
	//for (time = 0; time < 0xFFF; time++) {
		while (cubedma_TransferDone(S2MM)==0) {
			//err = SUCCESS;
	//		break;
	//	}
	}
