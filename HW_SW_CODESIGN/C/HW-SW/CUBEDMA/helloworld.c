...
//SEND DATA TO ACCELERATOR
	...
	cubedma(HyperData, receiver,512*N_bands);
	...
	for(int i = N_pixels*2-100 ; i < N_pixels*2 ; i++)
		xil_printf("%f; ", (float)((float)temparr[i])/pow(2,31));
