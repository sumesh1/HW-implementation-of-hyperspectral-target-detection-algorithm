...
################################################################
# This is a generated script based on design: cubedma
#
...
xilinx.com:user:cubedma_top:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: cubedma_top_0, and set properties
  set cubedma_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cubedma_top:1.0 cubedma_top_0 ]
  set_property -dict [ list \
   CONFIG.C_MM2S_AXIS_WIDTH {16} \
   CONFIG.C_MM2S_COMP_WIDTH {16} \
   CONFIG.C_MM2S_NUM_COMP {1} \
   CONFIG.C_S2MM_AXIS_WIDTH {64} \
   CONFIG.C_S2MM_COMP_WIDTH {64} \
 ] $cubedma_top_0
  ...
  connect_bd_intf_net -intf_net cubedma_top_0_m_axi_mem [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins cubedma_top_0/m_axi_mem]
  connect_bd_intf_net -intf_net cubedma_top_0_m_axis_mm2s [get_bd_intf_pins TopLevel_wrapper_0/S_AXIS] [get_bd_intf_pins cubedma_top_0/m_axis_mm2s]
  connect_bd_intf_net -intf_net div_gen_0_M_AXIS_DOUT [get_bd_intf_pins cubedma_top_0/s_axis_s2mm] [get_bd_intf_pins div_gen_0/M_AXIS_DOUT]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins cubedma_top_0/s_axi_ctrl_status] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins BRAM_WRAPPER_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net BRAM_WRAPPER_0_ALGORITHM_SELECT [get_bd_pins BRAM_WRAPPER_0/ALGORITHM_SELECT] [get_bd_pins TopLevel_wrapper_0/ALGORITHM_SELECT]
  ...
  connect_bd_net -net cubedma_top_0_mm2s_irq [get_bd_pins cubedma_top_0/mm2s_irq] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net cubedma_top_0_s2mm_irq [get_bd_pins cubedma_top_0/s2mm_irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BRAM_WRAPPER_0/s00_axi_aclk] [get_bd_pins TopLevel_wrapper_0/CLK] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins cubedma_top_0/clk] [get_bd_pins div_gen_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins BRAM_WRAPPER_0/s00_axi_aresetn] [get_bd_pins TopLevel_wrapper_0/RESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins cubedma_top_0/aresetn] [get_bd_pins div_gen_0/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces cubedma_top_0/m_axi_mem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BRAM_WRAPPER_0/s00_axi/reg0] SEG_BRAM_WRAPPER_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs cubedma_top_0/s_axi_ctrl_status/reg0] SEG_cubedma_top_0_reg0
